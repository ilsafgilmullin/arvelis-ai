...
const allowed = new Map([
  ...
  ['location-directory-sqlite', 'tests/.dist-location-directory-sqlite'],
  ...
  ['qwen-runtime-evaluation', 'tests/.dist-qwen-runtime-evaluation'],
  ['qwen-llamacpp-runtime', 'tests/.dist-qwen-llamacpp-runtime'],
]);
