...
export const starterPrompts = [
  {
    ...
    index: '01',
    title: 'Работа',
    description: 'Разобрать задачу, документ, решение или план действий.',
  ...
  },
  {
    ...
    index: '02',
    title: 'Учёба',
    description: 'Объяснить сложную тему и структурировать материал.',
  ...
  },
  {
    ...
    index: '03',
    title: 'Решение',
    description: 'Сравнить варианты по критериям и принять взвешенное решение.',
...
export const initialDemoThreads: DemoThread[] = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        role: 'assistant',
        mock: true,
        content: 'Это демонстрационный пример структуры ответа. Реальный AI не подключён. В production здесь появится проверяемый разбор цели, ограничений, рисков и последовательности действий.',
